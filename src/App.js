...
const Hero = () => (
  <SectionWrapper className="hero-section" id="hero">
    ...
    <div className="hero-icons">
      <a href="https://github.com/rathanpaki" target="_blank" rel="noopener noreferrer"><FaGithub /></a>
      <a href="https://www.linkedin.com/in/pakirathan/" target="_blank" rel="noopener noreferrer"><FaLinkedin /></a>
      <a href="mailto:pakipakirathan68@gmail.com"><FaEnvelope /></a>
    </div>
    <a href="https://github.com/rathanpaki" ><Button/></a>
  </SectionWrapper>
);
...
const About = () => (
  <SectionWrapper className="about-section" id="about">
    ...
    <p className="section-description">
      I'm Paki, an aspiring software engineer passionate about building digital solutions. My projects, We Care and EcoGifts, focus on tech for healthcare and sustainability. Always exploring new technologies!
    </p>
  </SectionWrapper>
);
...
const Contact = () => (
  <SectionWrapper className="contact-section" id="contact">
    ...
    <a href="mailto:pakipakirathan68@gmail.com" className="contact-button">Say Hi 👋</a>
  </SectionWrapper>
);
